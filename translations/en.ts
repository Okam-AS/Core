export default {
  ...
  storePage_reserveTable: "Reserve a table",
  reservationSheet_heading: "Reserve a table",
  reservationSheet_guests: "Number of guests",
  reservationSheet_guestsLabel: "guests",
  reservationSheet_date: "Date",
  reservationSheet_time: "Time",
  reservationSheet_today: "Today",
  reservationSheet_tomorrow: "Tomorrow",
  reservationSheet_closed: "Closed",
  reservationSheet_noSlots: "No available times this day",
  reservationSheet_contactHeading: "Contact details",
  reservationSheet_name: "Name",
  reservationSheet_phone: "Phone",
  reservationSheet_comment: "Comment (optional)",
  reservationSheet_submit: "Reserve table",
  reservationSheet_confirmedHeading: "Your table is reserved!",
  reservationSheet_confirmedInfo: "You will receive a confirmation by SMS.",
  reservationSheet_at: "at",
  reservationSheet_close: "Close",
  reservationPage_lunch: "Lunch",
  reservationPage_afternoon: "Afternoon",
  reservationPage_evening: "Evening",
  reservationPage_chooseTime: "Choose a time",
  reservationPage_fillContact: "Fill in name and phone",
  reservationPage_addToCalendar: "Add to calendar",
  reservationPage_backToStore: "Back to the store",
  reservationPage_slotTaken: "That time was just taken. Please choose another.",
  reservationPage_errorGeneric: "Something went wrong. Please try again.",
  reservationPage_tooManyRequests: "Too many attempts. Please wait a moment and try again.",
  reservationSheet_cancelInfoSms: "You can cancel via the link in the SMS.",
  reservationSheet_cancelInfoCall: "Call us if you need to change or cancel.",
  reservationCancel_heading: "Your reservation",
  reservationCancel_confirm: "Cancel reservation",
  reservationCancel_cancelled: "Your reservation has been cancelled.",
  reservationCancel_notFound: "We couldn't find a reservation for this link.",
  reservationCancel_notAllowed: "This reservation can't be cancelled online. Please call the restaurant.",
  reservationCancel_tooLate: "It's too late to cancel online. Please call the restaurant.",
  reservationCancel_backToStore: "To the store",
