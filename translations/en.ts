export default {
  ...
  checkoutPage_invoiceFee: "Invoice fee",
  ...
  checkoutPage_deliveryInstructionsHint: "E.g. phone number, doorbell or message",
  checkoutPage_deliveryInstructionsWoltNote: "Tip: The courier will only see your phone number if you enter it in the field above",
  ...
  // Company Meals — the company tab as a tender at checkout.
  checkoutPage_mealsHeading: "Company account",
  checkoutPage_mealsPayWithCompany: "{company} pays",
  checkoutPage_mealsPayMyself: "I'll pay myself",
  checkoutPage_mealsRemainingAllowance: "{amount} left this period",
  checkoutPage_mealsFullyCovered: "The company covers this order in full",
  checkoutPage_mealsExceedsAllowance: "This order costs more than the company can cover. Reduce it or pay it yourself — a company order cannot be split yet.",
  checkoutPage_mealsReserved: "Reserved for this order: {amount}",
  checkoutPage_mealsQuoteFailed: "The company account could not be reserved.",
  checkoutPage_mealsIneligible: "The company cannot cover this order right now.",
  checkoutPage_mealsIneligibleTimeWindow: "The company only covers meals inside its ordering hours.",
  checkoutPage_mealsAllowanceExceeded: "This period's company allowance is used up.",
  checkoutPage_mealsMembershipRevoked: "This company membership is no longer active.",
  checkoutPage_mealsOverReservedCap: "The order costs more than the company reserved. Reduce it or pay it yourself.",
  checkoutPage_mealsReservationExpired: "The company reservation expired. Choose it again.",
  checkoutPage_mealsCurrencyMismatch: "The company account cannot pay in this currency.",
  checkoutPage_mealsUnavailable: "The company account is unavailable right now.",
  ...
  checkoutPage_paymentInvoiceToggle: "Pay with invoice?",
  ...
  checkoutPage_isClosedForNow: "is closed at the selected time",
  checkoutPage_canTakeLonger: "We will respond as soon as we open.",
  ...
  checkoutPage_sameDayAfterHoursOrderNotAllowed: "This store does not accept orders for today outside opening hours. Choose a time on the next opening day.",
  ...
  checkoutPage_payWithBillieTo: "to",
  checkoutPage_payWithKravia: "Invoice",
  checkoutPage_payWithKraviaTo: "to",
  checkoutPage_payWithTwint: "TWINT",
  checkoutPage_continueToPayment: "Continue to payment",
  checkoutPage_waitingForVipps: "Waiting for Vipps",
  checkoutPage_waitingForTwint: "Waiting for TWINT",
  checkoutPage_paymentSuccessful: "Payment successful",
  checkoutPage_vippsPaymentAborted: "Vipps payment was cancelled",
  checkoutPage_waitingForPaymentProvider: "Waiting for payment provider",
  checkoutPage_paymentAborted: "Payment was cancelled",
  ...
  cartPage_confirmDelete: "Remove item?",
  ...
  rewardsPage_noCards: "You have no memberships yet",
  ...
  rewardMembershipModal_termsAcceptPrefix: "I accept the ",
  rewardMembershipModal_termsAcceptBold: "terms",
  rewardMembershipModal_termsAcceptSuffix: " for membership",
  ...
  paymentType_dinteroKravia: "Invoice",
  paymentType_woltMarketplace: "Paid via Wolt",
  paymentType_twint: "Paid with TWINT",
  ...
  orderPage_sendReceipt: "Send receipt by email",
  ...
  giftcardConfirmationPage_done: "Done",
  giftcardConfirmationPage_extraInfo: "The gift card you purchased has been paid and has now been sent to {phoneNumber}.",
  ...
  rewards_useReward: "Use reward points",
  rewards_points: "Reward points",
  giftcardPurchasePage_heading: "Receipt",
  ...
  categoriesPage_searchPlaceholder: "Search...",
  categoriesPage_searchResults: "Search results",
  categoriesPage_noSearchResults: "No results found",
  restaurantSwipingPage_findRestaurants: "Find nearby restaurants",
  restaurantSwipingPage_notAllRestaurants: "Not all restaurants use Okam yet.",
  restaurantSwipingPage_exploreNearby: "Here you can explore all restaurants near you.",
  restaurantSwipingPage_tipThem: "Feel free to tip them about Okam for easier ordering.",
  ...
  restaurantSwipingPage_priceModerate: "Moderate",
  restaurantSwipingPage_priceExpensive: "Expensive",
  restaurantSwipingPage_priceVeryExpensive: "Very Expensive",
  restaurantSwipingPage_priceNA: "Price N/A",
  consumer_cashback_heading: "Order through the app to get cashback!",
  consumer_cashback_description: "When you order through the app, you get money back in the form of reward points. You can use the reward points next time you order from us.",
  consumer_cashback_downloadButton: "Download",
  consumer_cashback_tipDescription: "TIP: When you order through the app, you get money back in the form of reward points. You can use the reward points next time you order from us.",
  consumer_confirmation_likedPlatformOnWeb: "Did you like {name} on the web?",
  consumer_confirmation_appPromoDescription: "Then you're going to love our app. There you can, among other things, turn on notifications for when your order is ready.",
  consumer_confirmation_downloadAppButton: "Download the app",
  consumer_nativeAppBanner_prompt: "Download the app to collect points!",
  consumer_nativeAppBanner_openButton: "Open",
  consumer_bankid_notApprovedError: "BankID not approved, please try again",
  consumer_companyInvoice_orgNumberNotFound: "Could not find a company with that organization number.",
  consumer_order_vatSuffix: "VAT",
  consumer_order_itemColumnHeader: "Item",
  consumer_order_quantityColumnHeader: "Qty",
  consumer_order_vatColumnHeader: "VAT",
  consumer_order_priceColumnHeader: "Price",
  consumer_order_totalLabel: "Total",
  consumer_order_vatRateColumnHeader: "VAT rate",
  consumer_order_taxBasisColumnHeader: "Basis",
  consumer_order_taxAmountColumnHeader: "VAT",
  consumer_order_totalInclVatColumnHeader: "Total incl. VAT",
};
