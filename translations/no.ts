export default {
  ...
  checkoutPage_invoiceFee: "Fakturagebyr",
  ...
  checkoutPage_deliveryInstructionsHint: "F.eks. telefonnummer, dørklokke eller beskjed",
  checkoutPage_deliveryInstructionsWoltNote: "Merk: Budet får kun se telefonnummeret ditt dersom du legger det inn i feltet over",
  ...
  // Company Meals — bedriftskontoen som betalingsmåte i kassen.
  checkoutPage_mealsHeading: "Bedriftskonto",
  checkoutPage_mealsPayWithCompany: "{company} betaler",
  checkoutPage_mealsPayMyself: "Jeg betaler selv",
  checkoutPage_mealsRemainingAllowance: "{amount} igjen i denne perioden",
  checkoutPage_mealsFullyCovered: "Bedriften dekker hele denne bestillingen",
  checkoutPage_mealsExceedsAllowance: "Denne bestillingen koster mer enn bedriften kan dekke. Reduser den eller betal selv — en bedriftsbestilling kan ennå ikke deles.",
  checkoutPage_mealsReserved: "Reservert til denne bestillingen: {amount}",
  checkoutPage_mealsQuoteFailed: "Kunne ikke reservere bedriftsdekning.",
  checkoutPage_mealsIneligible: "Bedriften kan ikke dekke denne bestillingen nå.",
  checkoutPage_mealsIneligibleTimeWindow: "Bedriften dekker bare måltider innenfor bestillingstiden sin.",
  checkoutPage_mealsAllowanceExceeded: "Bedriftsbeløpet for denne perioden er brukt opp.",
  checkoutPage_mealsMembershipRevoked: "Dette bedriftsmedlemskapet er ikke lenger aktivt.",
  checkoutPage_mealsOverReservedCap: "Bestillingen koster mer enn bedriften reserverte. Reduser den eller betal selv.",
  checkoutPage_mealsReservationExpired: "Bedriftsreservasjonen utløp. Velg den på nytt.",
  checkoutPage_mealsCurrencyMismatch: "Bedriftskontoen kan ikke betale i denne valutaen.",
  checkoutPage_mealsUnavailable: "Bedriftskontoen er utilgjengelig akkurat nå.",
  ...
  checkoutPage_customerReferenceHint: "Ordrereferanse (valgfritt)",
  checkoutPage_customerReferenceHeading: "Fakturareferanse",
  checkoutPage_customerReferencePlaceholder: "F.eks. ordrenummer",
  ...
  checkoutPage_noRewardForInStorePayment: "Obs! Bonuspoeng blir ikke samlet dersom du betaler på stedet",
  ...
  checkoutPage_isClosedForNow: "er stengt på valgt tidspunkt",
  ...
  checkoutPage_payWithBillieTo: "til",
  checkoutPage_payWithKravia: "Faktura",
  checkoutPage_payWithKraviaTo: "til",
  ...
  checkoutPage_waitingForTwint: "Venter på TWINT …",
  ...
  dinteroPayment_errorCancelled: "Betalingen ble avbrutt eller mislyktes. Vennligst prøv igjen.",
  ...
  feedback_dislikedText: "Har du en tilbakemelding? Vi setter stor pris på tips til hvordan vi kan bli bedre.",
  feedback_textViewHint: "Skriv inn din tilbakemelding her",
  feedback_sendFeedbackButton: "Send tilbakemelding",
  feedback_close: "Lukk",
  feedback_giveFeedback: "Gi tilbakemelding",
  ...
  giftcardPage_buyGiftcardDescription_lora: "Vil du glede noen du er glad i? Med gavekort fra Lora Restaurant kan de enkelt bestille fra resturanter og butikker i appen. Vi sender en sms til mottakeren dersom de ikke har appen fra før.",
  ...
  payment_processing2: "Vennligst vent...",
  payment_processing3: "Bekrefter transaksjon...",
  payment_processing4: "Nesten ferdig...",
  ...
  paymentType_dinteroKravia: "Faktura",
  paymentType_woltMarketplace: "Betalt via Wolt",
  paymentType_twint: "Betalt med TWINT",
  ...
  orderPage_trackDelivery: "Spor levering",
  ...
  confirmationPage_thankYou: "Takk for at du bestiller direkte her – det gir mer til stedet du handler hos!",
  ...
  categoriesPage_addAddress: "Legg til leveringsadresse",
  categoriesPage_outsideDeliveryZone: "Utenfor leveringssone",
  ...
  settings_name: "Navn",
  settings_firstName: "Fornavn",
  settings_lastName: "Etternavn",
  settings_email: "E-post",
  settings_emailAddress: "E-postadresse",
  settings_emailConfirmed: "Bekreftet",
  settings_emailNotConfirmed: "IKKE BEKREFTET",
  settings_emailSave: "Lagre",
  settings_emailSendConfirmationCode: "Send bekreftelseskode",
  settings_emailSendNewConfirmationCode: "Send ny kode",
  settings_emailInvalid: "E-postadressen er ikke gyldig",
  settings_emailCodeInvalid: "Bekreftelseskoden er ikke gyldig",
  settings_emailConfirmationCode: "Bekreftelseskode",
  settings_emailConfirmationCodeSubmit: "Bekreft",
  settings_emailConfimationSent: "E-post sendt med bekreftelseskode. Se i innboksen din for å bekrefte e-postadressen.",
  settings_theme: "Tema",
  ...
  general_processingPayment: "Prosesserer betaling, kan ta noen sekunder",
  general_processingPaymentStillWaiting: "Takk for tålmodigheten. Gi det et par sekunder til",
  ...
  giftcardConfirmationPage_done: "Ferdig",
  giftcardConfirmationPage_extraInfo: "Gavekortet du kjøpte er betalt og har nå blitt sendt til {phoneNumber}.",
  ...
  introModal_description2: "Okam tar ingen provisjon. Det betyr at en større del av det du betaler går direkte til butikken. Rettferdig og transparent.",
  ...
  categoriesPage_searchPlaceholder: "Søk...",
  categoriesPage_searchResults: "Søkeresultater",
  categoriesPage_noSearchResults: "Ingen treff",
  restaurantSwipingPage_findRestaurants: "Finn restauranter i nærheten",
  restaurantSwipingPage_notAllRestaurants: "Ikke alle restauranter bruker Okam enda.",
  restaurantSwipingPage_exploreNearby: "Her kan du utforske alle restaurantene i nærheten av deg.",
  restaurantSwipingPage_tipThem: "Tips dem gjerne om Okam for enklere bestilling.",
  ...
  restaurantSwipingPage_priceModerate: "Middels",
  restaurantSwipingPage_priceExpensive: "Dyrt",
  restaurantSwipingPage_priceVeryExpensive: "Veldig dyrt",
  restaurantSwipingPage_priceNA: "Pris ikke tilgjengelig",
  consumer_cashback_heading: "Bestill gjennom appen for å få cashback!",
  consumer_cashback_description: "Bestiller du gjennom appen får du tilbake penger i form av bonuspoeng. Bonuspoengene kan du bruke neste gang du bestiller hos oss.",
  consumer_cashback_downloadButton: "Last ned",
  consumer_cashback_tipDescription: "TIPS: Bestiller du gjennom appen får du tilbake penger i form av bonuspoeng. Bonuspoengene kan du bruke neste gang du bestiller hos oss.",
  consumer_confirmation_likedPlatformOnWeb: "Likte du {name} på web?",
  consumer_confirmation_appPromoDescription: "Da kommer du til å elske appen vår. Der kan du blant annet skru på varsling for når bestillingen din er klar.",
  consumer_confirmation_downloadAppButton: "Last ned appen",
  consumer_nativeAppBanner_prompt: "Last ned appen for å samle poeng!",
  consumer_nativeAppBanner_openButton: "Åpne",
  consumer_bankid_notApprovedError: "BankID ikke godkjent, prøv igjen",
  consumer_companyInvoice_orgNumberNotFound: "Fant ikke selskap med org.nr.",
  consumer_order_vatSuffix: "MVA",
  consumer_order_itemColumnHeader: "Vare",
  consumer_order_quantityColumnHeader: "Antall",
  consumer_order_vatColumnHeader: "MVA",
  consumer_order_priceColumnHeader: "Pris",
  consumer_order_totalLabel: "Totalt",
  consumer_order_vatRateColumnHeader: "MVA-sats",
  consumer_order_taxBasisColumnHeader: "Grunnlag",
  consumer_order_taxAmountColumnHeader: "MVA",
  consumer_order_totalInclVatColumnHeader: "Total ink. MVA",
};
