export default {
  ...
  storePage_reserveTable: "Reserver bord",
  reservationSheet_heading: "Reserver bord",
  reservationSheet_guests: "Antall gjester",
  reservationSheet_guestsLabel: "gjester",
  reservationSheet_date: "Dato",
  reservationSheet_time: "Tidspunkt",
  reservationSheet_today: "I dag",
  reservationSheet_tomorrow: "I morgen",
  reservationSheet_closed: "Stengt",
  reservationSheet_noSlots: "Ingen ledige tidspunkt denne dagen",
  reservationSheet_contactHeading: "Kontaktinformasjon",
  reservationSheet_name: "Navn",
  reservationSheet_phone: "Telefon",
  reservationSheet_comment: "Kommentar (valgfritt)",
  reservationSheet_submit: "Reserver bord",
  reservationSheet_confirmedHeading: "Bordet er reservert!",
  reservationSheet_confirmedInfo: "Du får bekreftelse på SMS.",
  reservationSheet_at: "kl.",
  reservationSheet_close: "Lukk",
  reservationPage_lunch: "Lunsj",
  reservationPage_afternoon: "Ettermiddag",
  reservationPage_evening: "Kveld",
  reservationPage_chooseTime: "Velg tidspunkt",
  reservationPage_fillContact: "Fyll inn navn og telefon",
  reservationPage_addToCalendar: "Legg til i kalender",
  reservationPage_backToStore: "Tilbake til butikken",
  reservationPage_slotTaken: "Tidspunktet ble nettopp opptatt. Velg et annet.",
  reservationPage_errorGeneric: "Noe gikk galt. Prøv igjen.",
  reservationPage_tooManyRequests: "For mange forsøk. Vent litt og prøv igjen.",
  reservationSheet_cancelInfoSms: "Du kan avbestille via lenken i SMS-en.",
  reservationSheet_cancelInfoCall: "Ring oss hvis du trenger å endre eller avbestille.",
  reservationCancel_heading: "Din reservasjon",
  reservationCancel_confirm: "Avbestill reservasjonen",
  reservationCancel_cancelled: "Reservasjonen er avbestilt.",
  reservationCancel_notFound: "Vi fant ingen reservasjon for denne lenken.",
  reservationCancel_notAllowed: "Denne reservasjonen kan ikke avbestilles på nett. Ring restauranten.",
  reservationCancel_tooLate: "Det er for sent å avbestille på nett. Ring restauranten.",
  reservationCancel_backToStore: "Til butikken",
