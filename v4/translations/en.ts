export default {
  ...
  rewardBar_description1: "The total of your orders over the past 30 days determines the percentage of bonus points you'll get back.",
  rewardBar_description2: "The bonus points you earn can be used at any time on orders through the app.",
  rewardBar_description3: "On your next order, you will receive {currentDiscount}% back. Once you have spent a total of {amount}, you will receive {nextDiscount}% back on the following order.",
  rewardBar_lastDaysYouHaveUsed: "Over the past 30 days, you have spent ",
