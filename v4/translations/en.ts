export default {
  ...
  rewardsCheckoutPage_purchaseGift: "Purchase gift card",
  rewardsCheckoutPage_giftDescription: "Invite a friend to the app by purchasing a bonus card as a gift!",
