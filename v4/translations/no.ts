export default {
  ...
  orderPage_orderNumber: 'Ordre #',
  orderPage_total: 'Totalt',
  orderPage_cancelOrder: 'Kanseller ordre',
  orderPage_confirmCancel: 'Kanseller ordre',
  ...
  orderPage_goBackToSelectOrder: 'Gå tilbake for å velge ordre',
