export default {
  ...
  checkoutPage_reward: "Bonuspoeng",
  ...
  rewardBar_description1: "Summen av bestillingene dine de siste 30 dagene bestemmer hvor mange prosent du får tilbake som bonuspoeng",
  rewardBar_description2: "Bonuspoengene du tjener kan du når som helst bruke på bestillinger gjennom appen",
  rewardBar_description3: "På neste bestilling får du {currentDiscount}% tilbake. Når du har handlet for totalt {amount} kr, får du {nextDiscount}% tilbake på bestillingen etter.",
  rewardBar_lastDaysYouHaveUsed: "De siste 30 dagene har du brukt ",
  ...
  rewardMembershipModal_iAcceptNotificationsFromStore: "Jeg aksepterer å motta spesielle tilbud og nyheter fra {name}",
  ...
  paymentType_reward: "Betalt med bonuspoeng",
  ...
  rewards_becomeMember: "Bli medlem for å samle poeng og få eksklusive tilbud",
