export default {
  ...
  checkoutPage_reward: "Betal med bonuskort",
  ...
  checkoutPage_cartHasUnknownError: "Beklager, vi støter på et problem med handlevognen din",
  ...
  checkoutPage_priceDifferError: "Prisene er endret siden sist. Gå tilbake for å oppdatere handlevogna.",
  ...
  checkoutPage_rewardBalanceTooLowError: "Saldoen på bonuskortet er for lav for denne bestillingen",
  ...
  paymentType_reward: "Betal med bonuskort",
  ...
  menu_rewards: "Bonuskort",
  rewardsCheckoutPage_purchase: "Fyll bonuskort",
  rewardsCheckoutPage_purchaseGift: "Kjøp bonuskort i gave",
  rewardsCheckoutPage_giftDescription: "Inviter en venn til appen ved å kjøpe et bonuskort i gave!",
  rewardsCheckoutPage_allowedStores: "Bonusen kan brukes på bestillinger gjennom appen på følgende steder:",
  rewardsCheckoutPage_pay: "Fullfør kjøp",
  rewardsCheckoutPage_termsAcceptPrefix: "Ved å kjøpe bonuspoeng aksepterer du ",
