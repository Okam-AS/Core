export default {
  ...
  rewardBard_description1: "Summen av bestillingene dine de siste 30 dagene bestemmer hvor mange prosent du får tilbake som bonuspoeng",
  rewardBard_description2: "Bonuspoengene du tjener kan du når som helst bruke på bestillinger gjennom appen",
  rewardBard_description3: "På neste bestilling får du {currentDiscount}% tilbake. Når du har handlet for totalt {amount} kr, får du {nextDiscount}% tilbake på bestillingen etter.",
  rewardBard_lastDaysYouHaveUsed: "De siste 30 dagene har du brukt ",
  ...
  giftcardCheckoutPage_selectAmount: "Velg beløp",
