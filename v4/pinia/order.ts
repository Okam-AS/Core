...
export const useOrder = defineStore("order", () => {
  ...
  const progressFlow = (deliveryType: DeliveryType, currentStatus: OrderStatus) => {
    ...
    if (deliveryType === DeliveryType.InstantHomeDelivery) return createSteps([OrderStatus.Accepted, OrderStatus.Processing, OrderStatus.ReadyForDriver, OrderStatus.Completed]);
