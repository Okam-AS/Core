import { Login, SendVerificationToken, User, RewardCard, UserForStore } from "../models";
...
export class UserService {
  ...
  public async GetForStore(storeId: number, userId: string): Promise<UserForStore> {
    if (!this._bearerToken) { return undefined; }
  ...
  public async Delete(logoutFunction?: Function): Promise<boolean> {
