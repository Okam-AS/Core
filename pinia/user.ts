...
import { isLegacyPhoneNumberValidV1, normalizeLegacyPhoneNumberV1 } from "../consumer-domain/legacy/phone";
...
export const useUser = defineStore("user", () => {
  ...
  // The Pinia contract continues to accept national significant numbers. V1's
  // E.164 API is deliberately separate until a consumer opts into that change.
  const normalizePhoneNumber = normalizeLegacyPhoneNumberV1;
  const phoneNumberIsValid = isLegacyPhoneNumberValidV1;
